/**
 * backbone model definitions for EMPRESA VANILTON
 */
...
/**
 * Recibo Backbone Model
 */
model.ReciboModel = Backbone.Model.extend({
	urlRoot: 'api/recibo',
	idAttribute: 'id',
	id: '',
	data: '',
...
/**
 * Recibo Backbone Collection
 */
model.ReciboCollection = model.AbstractCollection.extend({
	url: 'api/recibos',
	model: model.ReciboModel
});
