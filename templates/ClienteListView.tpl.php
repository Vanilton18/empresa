<?php
	$this->assign('title','EMPRESA VANILTON | Clientes');
...
<h1>
	<i class="icon-th-list"></i> Gerenciar Clientes
		...
		<form id="deleteClienteButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="bt_delete_cliente" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Excluir</button>
							<span id="confirmDeleteClienteContainer" class="hide">
							<button id="bt_cancelar_excluir" class="btn btn-mini">Cancelar</button>
							<button id="bt_confirmar_excluir" class="btn btn-mini btn-danger">Confirmar</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="clienteDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Manter Cliente
		...
		<div class="modal-footer">
			...
			<button id="bt_salvar_cliente" class="btn btn-primary">Salvar</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="bt_novo_cliente" class="btn btn-primary">Adicionar</button>
	</p>
